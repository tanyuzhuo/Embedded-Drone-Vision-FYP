...
def draw_bounding_box_on_image(image,
  ...
  if use_normalized_coordinates:
    ...
    y1= bottom-top
    area=x1*y1
    # print(' left, right, top, bottom coordinates are ', (left, right, top, bottom))
    # print(' centre point x,y is', x,  y)
  ...
  # return (left+right)/2, (top+bottom)/2, display_str_list
